...
if("TRUE" STREQUAL "TRUE")
  set(octomapping_SOURCE_PREFIX /home/amov/catkin_ws/src/octomapping)
  set(octomapping_DEVEL_PREFIX /home/amov/catkin_ws/src/octomapping/build/devel)
  ...
  set(octomapping_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/amov/catkin_ws/src/octomapping/include " STREQUAL " ")
  set(octomapping_INCLUDE_DIRS "")
  set(_include_dirs "/home/amov/catkin_ws/src/octomapping/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "https://github.com/HuaYuXiao/octomapping " STREQUAL " ")
    set(_report "Check the website 'https://github.com/HuaYuXiao/octomapping' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Eason Hua <hyx020222@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'octomapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/amov/catkin_ws/src/octomapping/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/amov/catkin_ws/src/octomapping/build/devel/lib;/home/amov/rplidar_ws/devel/lib;/home/amov/amovlab_ws/devel/lib;/home/amov/realsense_ws/devel/lib;/home/amov/Prometheus/devel/lib;/opt/ros/melodic/lib)
